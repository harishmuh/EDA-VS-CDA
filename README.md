...
your dataset. 
* Having a list of different information types (Time, Place, Product, Sales, etc.) that are in your 
dataset always helps.
...
**Choropleth map of profit across US**
 ![Choropleth map]() 
...
**CDA to test hypothesis**

![CDA]()

Based on the chart above, we can see that your assumption is invalid. The highest quantity of product sold came from the office supplies category.
